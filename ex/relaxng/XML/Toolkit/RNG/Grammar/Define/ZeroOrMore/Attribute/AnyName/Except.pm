...
use XML::Toolkit::RNG::Grammar::Define::ZeroOrMore::Attribute::AnyName::Except;

=head1 DESCRIPTION

The XML::Toolkit::RNG::Grammar::Define::ZeroOrMore::Attribute::AnyName::Except class implements ...
