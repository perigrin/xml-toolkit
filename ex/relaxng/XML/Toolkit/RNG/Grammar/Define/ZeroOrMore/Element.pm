...
XML::Toolkit::RNG::Grammar::Define::ZeroOrMore::Element - A class to ...
...
use XML::Toolkit::RNG::Grammar::Define::ZeroOrMore::Element;

=head1 DESCRIPTION

The XML::Toolkit::RNG::Grammar::Define::ZeroOrMore::Element class implements ...
