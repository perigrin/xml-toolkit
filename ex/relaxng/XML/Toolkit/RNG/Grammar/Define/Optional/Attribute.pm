...
XML::Toolkit::RNG::Grammar::Define::Optional::Attribute - A class to ...
...
use XML::Toolkit::RNG::Grammar::Define::Optional::Attribute;

=head1 DESCRIPTION

The XML::Toolkit::RNG::Grammar::Define::Optional::Attribute class implements ...
