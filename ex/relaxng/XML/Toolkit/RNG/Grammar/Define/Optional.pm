...
XML::Toolkit::RNG::Grammar::Define::Optional - A class to ...
...
use XML::Toolkit::RNG::Grammar::Define::Optional;

=head1 DESCRIPTION

The XML::Toolkit::RNG::Grammar::Define::Optional class implements ...
