...
XML::Aiml::Category::Template::Srai::Person - A class to ...
...
use XML::Aiml::Category::Template::Srai::Person;

=head1 DESCRIPTION

The XML::Aiml::Category::Template::Srai::Person class implements ...
