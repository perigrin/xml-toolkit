...
XML::Aiml::Category::Template::Condition::B - A class to ...
...
use XML::Aiml::Category::Template::Condition::B;

=head1 DESCRIPTION

The XML::Aiml::Category::Template::Condition::B class implements ...
